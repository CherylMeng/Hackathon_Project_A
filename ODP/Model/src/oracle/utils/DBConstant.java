...
public class DBConstant {
    ...
    public static final String ORDER_STATUS_REFUSED = "REFUSED";
    ...
    public static final String MANAGEMENT_TYPE_ACCOUNT = "Account";
    public static final String MANAGEMENT_TYPE_ORDER = "Order";
