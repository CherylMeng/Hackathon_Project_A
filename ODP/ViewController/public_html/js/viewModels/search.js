require(
    [ 'ojs/ojcore', 'knockout', 'jquery',
        'viewModels/search/ojSearch',
        'viewModels/search/AdvancedSearchViewModel',
        'ojs/ojcomponents', 'ojs/ojselectcombobox', 'ojs/ojmodule',
        'promise', 'mockjax', 'mocksolr'
    ],
    function(oj, ko, $, ojSearch, AdvancedSearchViewModel) {
      $(document)
          .ready(
              function() {
                ...
                $("#selection").text("Loading Demo...");
                $.getJSON("cookbook/formControls/inputSearch/employees.json",
                  function (data) {
                  new MockSolrServer(data, {url:/^http:\/\/mocksolr\/collection\/select.*/i});

                   ko.applyBindings(viewModel, document
